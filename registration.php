...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <input type="text" name="contact" id="contact" class="form-control" onBlur="mobAvailability()" required="required">
...
function mobAvailability() {
    ...
    if (isValid) {
        ...
        jQuery.ajax({
            ...
            error: function () {
                event.preventDefault();
                alert('Error occurred while validating mobile number');
            }
        });
    } else {
        $("#mobile-availability-status").html("<span style='color: red;'>Please enter a valid 10-digit mobile number.</span>");
    }
}
</script>
	<script>
